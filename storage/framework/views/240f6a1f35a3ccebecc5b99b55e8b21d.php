...
<body class="bg-gray-50">
    ...
    <header class="bg-orange-500 text-white shadow-lg">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            <div class="flex items-center gap-3">
                <img src="<?php echo e(asset('images/logo-xadventure-white.png')); ?>" alt="X Adventure" class="h-10">
            </div>
            
            <nav class="hidden md:flex items-center gap-6">
                <a href="<?php echo e(route('home')); ?>" class="hover:text-orange-200 transition">Beranda</a>
                <a href="<?php echo e(route('katalog.paket')); ?>" class="hover:text-orange-200 transition">Katalog Paket</a>
                <a href="<?php echo e(route('katalog.peralatan')); ?>" class="hover:text-orange-200 transition">Katalog Peralatan</a>
                <a href="<?php echo e(route('tentang-kami')); ?>" class="hover:text-orange-200 transition">Tentang Kami</a>
                
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="bg-white text-orange-500 px-4 py-2 rounded-lg font-semibold hover:bg-orange-100 transition">
                        Dashboard Admin
                    </a>
                <?php else: ?>
                <?php endif; ?>
        ...
        <div class="absolute inset-0 flex items-center justify-center">
            <div class="text-center text-white px-4">
                ...
                <div class="flex gap-4 justify-center flex-wrap">
                    <a href="<?php echo e(route('katalog.paket')); ?>" class="bg-orange-500 text-white px-8 py-4 rounded-lg text-lg font-bold hover:bg-orange-600 transition shadow-lg">
                        Lihat Paket
                    </a>
                    <a href="<?php echo e(route('katalog.peralatan')); ?>" class="bg-white text-orange-500 px-8 py-4 rounded-lg text-lg font-bold hover:bg-gray-100 transition shadow-lg">
                        Lihat Peralatan
                    </a>
    ...
    <section class="bg-orange-500 text-white py-16">
        <div class="container mx-auto px-4 text-center">
            ...
            <div class="flex gap-4 justify-center flex-wrap">
                <a href="<?php echo e(route('katalog.paket')); ?>" class="bg-white text-orange-500 px-8 py-4 rounded-lg text-lg font-bold hover:bg-gray-100 transition">
                    Mulai Sewa
                </a>    
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="<?php echo e(route('home')); ?>" class="hover:text-orange-500">Beranda</a></li>
                        <li><a href="<?php echo e(route('katalog.paket')); ?>" class="hover:text-orange-500">Katalog Paket</a></li>
                        <li><a href="<?php echo e(route('tentang-kami')); ?>" class="hover:text-orange-500">Tentang Kami</a></li>
                        <?php if(auth()->guard()->guest()): ?>
                        <li><a href="<?php echo e(route('login')); ?>" class="hover:text-orange-500">Login Admin</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
            <div class="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
                Copyright © <?php echo e(date('Y')); ?> X Adventure. All rights reserved.
            </div>
        </div>
    </footer>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\camp-ecommerce\rental_camping2\resources\views/welcome.blade.php ENDPATH**/ ?>