...
<div class="max-w-2xl mx-auto">
    ...
    <form action="{{ route('admin.kategori.update', $kategori->id_kategori) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-lg p-8">
        @csrf
        @method('PUT')
        ...
        <div class="mb-6">
            ...
            <input 
                ...
                value="{{ old('label_kategori', $kategori->label_kategori) }}"
            >
        </div>
        ...
        <div class="mb-6">
            ...
            <div class="mb-4">
                <img src="{{ asset('storage/' . $kategori->gambar_kategori) }}" alt="{{ $kategori->label_kategori }}" class="w-32 h-32 object-cover rounded-lg">
